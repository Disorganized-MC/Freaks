...
public class SheeperModel extends GeoModel<SheeperEntity> {

	@Override
	public Identifier getModelResource(SheeperEntity animatable) {
		return Freaks.of("geo/entity/sheeper/default.geo.json");
	}

	@Override
	public Identifier getTextureResource(SheeperEntity animatable) {
		return Freaks.of("textures/entity/sheeper/default.png");
	}
